...
for TAB in "Local SMBs" "MEDSPAS" "INDIA_MEDSPAS" "USA_DentalOffices" "INDIA_DentalOffices" "USA_Salons" "USA_BarberShops" "USA_FinancialAdvisorsandInsuranceAgents" "USA_RealEstateAgents" "USA_Restaurants" "India_Restaurants" "USA_LawFirms"; do
