...
# ─── Sheet scraping — 12 tabs, APPEND ONLY ───────────────────────────────────
# All 12 tabs use scrape-universal.ts. Never clears existing rows.
# Header: Date | Name | Niche | City | State | Timezone | Phone | Email |
#         Has Website | Website URL | Address | Rating | Reviews |
...
# 6 tabs × 12 runs/day × 150 leads = 1,800/day each = 10,800/day total
# All 144 cron jobs load env from ~/.webcrew.env (not Documents — avoids macOS TCC)
#
#   MEDSPAS              all hours  :00  (12 × 150 = 1,800/day)  com.webcrew.medspa-*
#   INDIA_MEDSPAS        all hours  :30  (12 × 150 = 1,800/day)  com.webcrew.india-medspa-*
#   USA_DentalOffices    all hours  :15  (12 × 150 = 1,800/day)  com.webcrew.tab-usa-dentaloffices-*
#   INDIA_DentalOffices  all hours  :15  (12 × 150 = 1,800/day)  com.webcrew.tab-india-dentaloffices-*
#   USA_Salons           all hours  :45  (12 × 150 = 1,800/day)  com.webcrew.tab-usa-salons-*
#   USA_BarberShops      all hours  :45  (12 × 150 = 1,800/day)  com.webcrew.tab-usa-barbershops-*
#
# ── OTHER TABS (1,000/day each) ───────────────────────────────────────────────
#   Local SMBs           all hours  :00  (12 × 150 = 1,800/day)  com.webcrew.scrape-*
#   USA_FinancialAdvisorsandInsuranceAgents  1,3,5...21 :05  (10 × 100 = 1,000/day)
#   USA_RealEstateAgents                     2,4,6...20 :05  (10 × 100 = 1,000/day)
#   USA_Restaurants                          1,3,5...21 :35  (10 × 100 = 1,000/day)
#   India_Restaurants                        2,4,6...20 :35  (10 × 100 = 1,000/day)
#   USA_LawFirms                             odd hours  :55  (10 × 100 = 1,000/day)
#
# env fix: DATABASE_URL quoted in pipeline/.env (& breaks zsh source)
#          All plists source ~/.webcrew.env with GOOGLE_SERVICE_ACCOUNT_FILE as absolute path
#
# Manual runs:
...
# (SHEET_TAB = any of the 12 tab names above)
cd pipeline && SCRAPE_TARGET=500 SHEET_TAB="MEDSPAS" npx tsx src/scripts/scrape-universal.ts  # bulk run

# Sheet management
cd pipeline && npx tsx src/scripts/init-all-headers.ts          # write 18-col header to all 12 tabs (safe, skips if correct)
...
npm run dev:roofing
npm run dev:dentist
# ... dev:<niche> for any of the 12 niches
...
# Apply DB migration (run once, idempotent)
...
# Gemini Live model (default: stable, override for native audio):
#   GEMINI_LIVE_MODEL=models/gemini-2.5-flash-preview-native-audio-dialog  # preview — use with caution
#   GEMINI_LIVE_MODEL=models/gemini-2.0-flash-live-001                     # stable (default)
```
...
| `pipeline/src/scripts/scrape-universal.ts` | **Master scraper** — all 11 tabs, append-only, 18-column header. Use `SHEET_TAB=<tab>` env |
